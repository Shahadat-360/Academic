...
select title_id from titleauthor where au_id in (select au_id from  authors where au_id='172-32-1176') and title_id in (select title_id from titles )--where pub_id='1389'))
